...
lacking a role in the spine is deferred or dropped.
...
sentence. If that cannot be done from the note alone, repair the structure before polishing prose. A mechanically valid
heading tree is not a clarity pass.
